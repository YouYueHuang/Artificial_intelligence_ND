...
In this project, I will build a system that can recognize words communicated using the American Sign Language (ASL). With a preprocessed dataset of tracked hand and nose positions extracted from video, I will train a set of Hidden Markov Models (HMMs) using part of this dataset to try and identify individual words from test sequences. To improve the recognition accuracy of the system, I incorporated statistical language model (SLM) that capture the conditional probability of particular sequences of words occurring.
